...
categories = os.listdir(r'D:\python\project\DSP\CrackFormer-II-main\datasets\CrackTree260') # 加入 r 可以不用专门的去处理引号之中的特殊字符

print(categories)
# rawdata_path = os.path.join(base_path, r"D:\python\project\DSP\CrackFormer-II-main\datasets\CrackLS315\train\valid")
rawdata_path = 'D:\python\project\DSP\CrackFormer-II-main\datasets\CrackTree260'
print(rawdata_path)

# 将其存储为Txt文件
with open(r"D:\python\project\DSP\kaggle-crackFormer\datasets\CrackTree260\train.txt", 'w') as f:
    for c in categories:
